...
export default function CreateMovie() {
  ...
  // Verifica permissão (redireciona se não for admin/vendedor)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Criar o filme com a URL da imagem retornada
      const movieData = {
        title,
        genre,
        rating,
        ...
        poster_url,
        status: 'now_playing' // Poderia ter uma lógica baseada na data de estreia
      };
    ...
    >
      ...
      <div className="space-y-4 mb-12">
        <h1 className="font-display text-4xl md:text-5xl font-black uppercase italic tracking-tighter">
          Adicionar Novo <span className="text-cinema-red text-glow">Filme</span>
        </h1>
        <p className="text-white/50">
          Preencha os dados abaixo para disponibilizar um novo título no sistema.
        </p>
      </div>
